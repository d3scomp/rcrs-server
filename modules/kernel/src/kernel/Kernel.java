    ...
    public void timestep() throws InterruptedException, KernelException, LogException {
        try {
            ...
            synchronized (this) {
                ...
                Logger.info("Score: " + s);
                Logger.info("Perception took        : " + (perceptionTime - start) + "ms");
                Logger.info("Agent commands took    : " + (commandsTime - perceptionTime) + "ms");
                Logger.info("Simulator updates took : " + (updatesTime - commandsTime) + "ms");
                Logger.info("World model merge took : " + (mergeTime - updatesTime) + "ms");
                Logger.info("Update broadcast took  : " + (broadcastTime - mergeTime) + "ms");
                Logger.info("Score calculation took : " + (scoreTime - broadcastTime) + "ms");
                Logger.info("Total time             : " + (scoreTime - start) + "ms");
