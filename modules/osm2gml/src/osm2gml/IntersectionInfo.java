...
*/
public class IntersectionInfo implements OSMShape {
    ...
    */
    public IntersectionInfo(OSMNode centre) {
        this.centre = centre;
    ...
    */
    public void addRoadSegment(RoadInfo road) {
    ...
    */
    ...
    private static class RoadAspect {
        ...
        RoadAspect(RoadInfo road, OSMNode intersection) {
            this.road = road;
