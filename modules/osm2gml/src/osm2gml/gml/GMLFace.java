...
public class GMLFace extends GMLObject {
    ...
    */
    public GMLFace(long id, FaceType type, List<GMLDirectedEdge> edges, List<Coordinates> points) {
        super(id);
        this.type = type;
        this.edges = edges;
    ...
    */
    public List<Coordinates> getOutline() {
        return new ArrayList<Coordinates>(points);
    }
    ...
    */
    public Area getArea() {
        if (area == null) {
            ...
            Coordinates c = edge.getStartCoordinates();
