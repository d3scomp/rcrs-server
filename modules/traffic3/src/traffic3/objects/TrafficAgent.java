...
public class TrafficAgent extends TrafficObject {
    ...
    */
	...
	double sumopz = 0;
	{
	    ...
	    //TrafficAgent[] agent_list = getManager().getAgentList();
	    TrafficAgent[] agent_list = now_area_.getAgentList();
	...
	fz_ = destz + sumopz;
	if(Double.isNaN(fx_) || Double.isNaN(fy_) || Double.isNaN(fz_)) fx_=fy_=fz_=0;
	// log(fx_);
    }
